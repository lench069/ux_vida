(function () {
	angular.module('polizaResumeNewEx', [])
		.directive('polizaResumeNewEx', function () {
			return {
				restrict: 'E',
				templateUrl: './src/new-experience/poliza-resume-newEx/poliza-resume-newEx.html',
				controller: polizaResumeNewExController
			};
		}).service('resumeServNewExp', function () {
			var ret = function () { };
			var polizaEmit = [];
			var polizaEmitOK = [];
	...
	var polizaResumeNewExController = ['$scope', '$rootScope', 'formEmitServ', '$mdDialog', 'issueRepo', 'cotizadorServ', '$location', 'resumeServ', 'formsRepo', 'customerServ', function ($scope, $rootScope, formEmitServ, $mdDialog, issueRepo, cotizadorServ, $location, resumeServ, formsRepo, customerServ) {

		$scope.asegurado = customerServ.getUser(); // customerServ.getUser(); // Validar para el reenvio de mail.
		$scope.errorCotizacion = false;
		$scope.aceptacionDigital = $rootScope.aceptacionDigitalRoot;
		...
		$scope.showPrint = function (indexCoti) {
			$mdDialog.show({
				...
				templateUrl: './src/new-experience/poliza-print/poliza-print.html',
		...
		$scope.salir = function () {
			...
			var params = {
				description: '¿Está seguro que desea salir de esta página?',
				nameBttOK: 'Aceptar',
